...
public class JwtUtil {
    ...
    public static final long DEFAULT_EXPIRE_TIME = 3600*1000*3;

    private static final String SECRET = "hubor";


    public static String createJWT(String subject) {
        return createJWT(SECRET, subject);
    }

    public static String createJWT(String jwtSec, String subject) {
        return createJWT(jwtSec, DEFAULT_EXPIRE_TIME, subject);
    }

    public static String createJWT(String jwtSec, long ttlMillis, String subject) {
    ...
    public void testJWT() {
        ...
        System.out.println(JwtUtil.parseJWT(JwtUtil.SECRET, jwt));
    }
}
